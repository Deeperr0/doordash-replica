...
const Navbar = () => {
	...
	return (
		<nav className={isSticky ? "header sticky visible" : "header"}>
			<div className={isSticky ? "title sticky visible" : "title"}>
				<div className={isSticky ? "logo sticky visible" : "logo"}>
					<svg
						aria-hidden="true"
						width={isSticky ? "32" : "42"}
						height={isSticky ? "18" : "24"}
					...
					<svg
						aria-hidden="true"
						width={isSticky ? "112" : "155"}
						height={isSticky ? "13" : "18"}
